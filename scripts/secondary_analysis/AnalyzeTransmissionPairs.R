...
trans_freq.p <- ggplot(trans_freq, aes(x = freq1, y = freq2)) + geom_point(size = 1.5) + xlab("Frequency in donor") + ylab("Frequency in recipient") + theme_classic() #+ theme(text = element_text(size = 35), axis.text.x = element_text(size = 20), axis.text.y = element_text(size = 20))
...
ggsave(plot = trans_freq.p, filename = "results/plots/RecipientVsDonorAll_square.pdf", device = "pdf", width = 4, height = 3)
...
ggsave(plot = no_cut_trans_freq.p, filename = "results/plots/RecipientVsDonorAll_NoCutoff_square.pdf", device = "pdf", width = 10, height = 10)
ggsave(plot = no_cut_trans_freq.comp.p, filename = "results/plots/RecipientVsDonor_DonorPolymorphic_NoCutoff_square.pdf", device = "pdf", width = 10, height = 10)
